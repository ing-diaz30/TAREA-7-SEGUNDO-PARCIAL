...
TOKEN = '1907532091:AAGVZLy2omfQX7Jt1tzuQqdf31yrE2HdYj4'
...
imageSelect.add('Grados Celsius a Grados Farenheit ', 'Grados Farenheit a Grados Celsius')
...
def msg_image_select(m):
    ...
    if text == 'Grados Celsius a Grados Farenheit':  
        bot.send_chat_action(cid, 'typing')
        time.sleep(3)
        bot.send_message(cid, "A continuacíon se le mostrará la formula")
        bot.send_chat_action(cid, 'upload_photo')
        time.sleep(5)   
        bot.send_photo(cid, open('celsius_a_farenheit.png', 'rb'),
    ...
    elif text == 'Grados Farenheit a Grados Celsius':
        bot.send_chat_action(cid, 'typing')
        time.sleep(3)
        bot.send_message(cid, "A continuacíon se le mostrará la formula")
        bot.send_chat_action(cid, 'upload_photo')
        time.sleep(5)   
        bot.send_photo(cid, open('farenheit_a_celsius.png', 'rb'),
                       reply_markup=hideBoard)
        bot.send_chat_action(cid, 'typing')
        time.sleep(3)
